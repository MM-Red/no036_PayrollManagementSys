            ...
            yuangongChange(id){
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                      ...
                      let zhiwei = data.data.zhiweiValue
                      let params1 = {}, params2 = {}
                      let aaa = 0.0, bbb = 0.0
                      params1['indexName'] = zhiwei//编码名字
                      params1['dicCode'] = "jintie_types"//编码名字
                      params1['dicName'] = "津贴类型"//汉字名字
                      _this.$http({
                        url: "dictionary/page",
                        method: "get",
                        params: params1
                      }).then(({ data }) => {
                        if (data.data.total > 0 && data.code === 0) {
                          ...
                          this.ruleForm.butieJine = aaa
                        } else {
                          this.ruleForm.butieJine = 0.0
                        }
                      });
                      params2['indexName'] = zhiwei
                      params2['dicCode'] = "jixiao_types"//编码名字
                      params2['dicName'] = "绩效类型",//汉字名字
                      _this.$http({
                        url: "dictionary/page",
                        method: "get",
                        params: params2
                        ...
                        if (data.data.total > 0 && data.code === 0) {
                          ...
                          this.ruleForm.jixiaoJine = bbb
                        } else {
                          this.ruleForm.jixiaoJine = 0.0
                        }
                      });
                    }
                });
